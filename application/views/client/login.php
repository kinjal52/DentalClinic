	...
	<section class="fxt-template-animation fxt-template-layout6" data-bg-image="<?= LOGIN_PATH?>img/figure/bg-01.jpg">
		...
		<div class="fxt-content">
			<div class="fxt-form">
				...
				<form method="POST" action="<?php echo base_url();?>Client/user_auth">
					<div class="form-group">
						<div class="fxt-transformY-50 fxt-transition-delay-3">
							<input type="email" class="form-control" name="user_name" placeholder="Email Address" required="required">
						</div>
					</div>
					<div class="form-group">
						<div class="fxt-transformY-50 fxt-transition-delay-4">
							<input type="password" class="form-control" id="myInput" name="user_password" placeholder="Password" required="required">
							<span class="field-icon" data-placeholder="&#xf191;"><input type="checkbox" onclick="myFunction()">
						</div>
					</div>
					<div class="form-group">
						<div class="fxt-transformY-50 fxt-transition-delay-5">
							<div class="fxt-content-between">
								...
								<a href="<?php echo base_url();?>Client/forgetpassword" class="switcher-text" class="fxt-transformY-50 fxt-transition-delay-10">Forgot Password</a>
							</div>
						</div>
					</div>
