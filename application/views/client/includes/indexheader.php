...
<div class="slider-item" style="background-image: url('<?= USER_PATH?>images/bg1.jpg');">
...
<div class="slider-item" style="background-image: url('<?= USER_PATH?>images/bg5.jpg');">
<div class="overlay"></div>
<div class="container">
<div class="row slider-text align-items-center" data-scrollax-parent="true">
<div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
...
<div class="slider-item" style="background-image: url('<?= USER_PATH?>images/bg6.jpg');">
<div class="overlay"></div>
<div class="container">
<div class="row slider-text align-items-center" data-scrollax-parent="true">
<div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
