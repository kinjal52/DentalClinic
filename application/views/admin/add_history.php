                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form method="post" action="<?php echo base_url();?>Admin/inserthistory" id="form_sample_1"  class="form-horizontal" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="Time" name="time" data-required="1" class="form-control input-height" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="amount" data-required="1" class="form-control input-height" />
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="date" name="return_date" data-required="1" class="form-control input-height" />
                                                </div>
                                            </div>
                                ...
                                <?php } else { ?>
                                    <form method="post" action="<?php echo base_url();?>Admin/updatehistory" id="form_sample_1"  class="form-horizontal" enctype="multipart/form-data">
                                        <div class="form-body">
                                            <div class="form-group row">
