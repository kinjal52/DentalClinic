				...
				<div class="col-md-12">
										    ...
										    <div class="card-body ">
									            <div class="row">
													<div class="col-md-6 col-sm-6 col-xs-6">
													    <div class="btn-group">
															<a href="<?php echo base_url();?>Admin/addprescription" id="addRow"class="btn btn-info">Add New <i class="fa fa-plus"></i>
															</a>
														</div>
													</div>
													<div class="col-md-6 col-sm-6 col-xs-6">
					...
					<table class="table table-hover table-checkable order-column full-width" id="example4">
						...
						<tbody>
							...
							<?php $no=1;
                          foreach($prescription_data as $pdata)
                          {
                           ?>
                           <tr>
                            <td><?php echo $no++;?></td>
                            <td><?php echo $pdata['patient_name'];?> </td>                         
                            <td><?php echo $pdata['treatment_name'];?></td>
                            <td><?php echo $pdata['medicine_name'];?></td>
                            <td><?php echo $pdata['date'];?></td>
                            <td><?php echo $pdata['description'];?></td>
                            <td>
							<a href="<?php echo base_url();?>Admin/editprescription/<?php echo $pdata['prescription_id_pk']; ?>" class="btn btn-primary btn-xs">		
								<i class="fa fa-pencil"></i>
							</a>
							<a href="<?php echo base_url();?>Admin/deleteprescription/<?php echo $pdata['prescription_id_pk']; ?>" class="btn btn-danger btn-xs">
