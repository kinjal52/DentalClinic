										    ...
										    <div class="card-body ">
									            <div class="row">
													<div class="col-md-6 col-sm-6 col-xs-6">
													    <div class="btn-group">
															<a href="<?php echo base_url();?>Admin/addpatient" id="addRow"class="btn btn-info">Add New <i class="fa fa-plus"></i>
															</a>
														</div>
													</div>
													<div class="col-md-6 col-sm-6 col-xs-6">
						...
						<tbody>
                         ...
                         <!--   <script type="text/javascript">
                           ...
                           <tr>
                            ...
                            <td>
							<a href="<?php echo base_url();?>Admin/deletehistory/<?php echo $history['history_id_pk']; ?>" class="btn btn-danger btn-xs">
